...
export class addUsersUserProfilesCountriesLanguagesIndustriesTables1630225060069 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`test\`.\`user_profiles\` (\`id\` char(36) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`version\` int NOT NULL, \`user_id\` varchar(255) NOT NULL, \`phone\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`linked_in\` varchar(255) NULL, \`rate\` varchar(255) NOT NULL, \`hours_per_week\` int NOT NULL, \`avatar\` varchar(255) NULL, \`headline\` varchar(255) NOT NULL, \`bio\` varchar(1023) NOT NULL, \`country_id\` char(36) NOT NULL, \`yose\` int NOT NULL, \`sale_channel\` varchar(255) NULL, \`sale_skill\` varchar(255) NULL, \`work_history\` varchar(1023) NULL, \`userId\` char(36) NULL, UNIQUE INDEX \`REL_8481388d6325e752cd4d7e26c6\` (\`userId\`), UNIQUE INDEX \`REL_08cebbf6264e68ce171deaf3e9\` (\`country_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`test\`.\`user_profiles_languages\` (\`userProfilesId\` char(36) NOT NULL, \`languagesId\` char(36) NOT NULL, INDEX \`IDX_d88f08e9592aed3e96039b61b7\` (\`userProfilesId\`), INDEX \`IDX_a88d4365dc7841de0ba6fead76\` (\`languagesId\`), PRIMARY KEY (\`userProfilesId\`, \`languagesId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`test\`.\`user_profiles_industries\` (\`userProfilesId\` char(36) NOT NULL, \`industriesId\` char(36) NOT NULL, INDEX \`IDX_bcf3d9bc6593fa857efd0d90c5\` (\`userProfilesId\`), INDEX \`IDX_6c0febd49f7d20450fce923a3d\` (\`industriesId\`), PRIMARY KEY (\`userProfilesId\`, \`industriesId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`test\`.\`user_profiles\` ADD CONSTRAINT \`FK_8481388d6325e752cd4d7e26c6d\` FOREIGN KEY (\`userId\`) REFERENCES \`test\`.\`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`test\`.\`user_profiles\` ADD CONSTRAINT \`FK_08cebbf6264e68ce171deaf3e97\` FOREIGN KEY (\`country_id\`) REFERENCES \`test\`.\`countries\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`test\`.\`user_profiles_languages\` ADD CONSTRAINT \`FK_d88f08e9592aed3e96039b61b70\` FOREIGN KEY (\`userProfilesId\`) REFERENCES \`test\`.\`user_profiles\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE \`test\`.\`user_profiles_industries\` ADD CONSTRAINT \`FK_bcf3d9bc6593fa857efd0d90c51\` FOREIGN KEY (\`userProfilesId\`) REFERENCES \`test\`.\`user_profiles\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`test\`.\`user_profiles_industries\` DROP FOREIGN KEY \`FK_bcf3d9bc6593fa857efd0d90c51\``);
        await queryRunner.query(`ALTER TABLE \`test\`.\`user_profiles_languages\` DROP FOREIGN KEY \`FK_a88d4365dc7841de0ba6fead763\``);
        await queryRunner.query(`ALTER TABLE \`test\`.\`user_profiles_languages\` DROP FOREIGN KEY \`FK_d88f08e9592aed3e96039b61b70\``);
        await queryRunner.query(`ALTER TABLE \`test\`.\`user_profiles\` DROP FOREIGN KEY \`FK_08cebbf6264e68ce171deaf3e97\``);
        await queryRunner.query(`ALTER TABLE \`test\`.\`user_profiles\` DROP FOREIGN KEY \`FK_8481388d6325e752cd4d7e26c6d\``);
        await queryRunner.query(`DROP INDEX \`IDX_6c0febd49f7d20450fce923a3d\` ON \`test\`.\`user_profiles_industries\``);
        await queryRunner.query(`DROP INDEX \`IDX_bcf3d9bc6593fa857efd0d90c5\` ON \`test\`.\`user_profiles_industries\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_d88f08e9592aed3e96039b61b7\` ON \`test\`.\`user_profiles_languages\``);
        await queryRunner.query(`DROP TABLE \`test\`.\`user_profiles_languages\``);
        await queryRunner.query(`DROP INDEX \`REL_08cebbf6264e68ce171deaf3e9\` ON \`test\`.\`user_profiles\``);
        await queryRunner.query(`DROP INDEX \`REL_8481388d6325e752cd4d7e26c6\` ON \`test\`.\`user_profiles\``);
